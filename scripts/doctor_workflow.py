...
WORKFLOW_REQUIRED_FILES = [
    ...
    "ai/skill-context/rules-v1.json",
    "ai/task-card-components/catalog.json",
    "ai/task-card-components/catalog.md",
    "ai/task-card-components/core.md",
    "ai/task-card-components/builder.md",
    "ai/task-card-components/batch-builder.md",
    "ai/task-card-components/solution-planner.md",
    "ai/task-card-components/checker.md",
    "ai/task-card-components/revision.md",
    "ai/task-card-components/control-plane.md",
    "ai/task-card-components/spec.md",
    "ai/task-card-components/root-cause.md",
    "ai/task-card-components/tdd.md",
    "ai/task-card-components/large-repo.md",
    "ai/task-card-components/parallel.md",
    "ai/task-card-components/advisor.md",
    "ai/task-card-components/spark.md",
    "ai/compose_task_card.py",
    "ai/compile-skill-context.py",
    ...
    "ai/archive-control-files.py",
    "ai/build-takeover-receipt.py",
    "ai/create-dirty-snapshot.py",
    "ai/enforce-checker-contract.py",
    "ai/validate-revision-card.py",
    "ai/compare-transfer-pilot.py",
    "ai/classify-claude-attempt.py",
    "ai/validate-claude-context.py",
    "ai/build-context-checkpoint.py",
    "ai/build-recovery-delta.py",
    "ai/schemas/context-compilation-v1.schema.json",
    "ai/schemas/context-checkpoint-v1.schema.json",
    "ai/schemas/recovery-delta-v1.schema.json",
...
WORKFLOW_PLAIN_FILE_SOURCES = [
    ...
    ("assets/skill-context/rules-v1.json", "ai/skill-context/rules-v1.json"),
    ...
    ("assets/task-card-components/core.md", "ai/task-card-components/core.md"),
    ("assets/task-card-components/builder.md", "ai/task-card-components/builder.md"),
    ("assets/task-card-components/batch-builder.md", "ai/task-card-components/batch-builder.md"),
    ("assets/task-card-components/solution-planner.md", "ai/task-card-components/solution-planner.md"),
    ("assets/task-card-components/checker.md", "ai/task-card-components/checker.md"),
    ("assets/task-card-components/revision.md", "ai/task-card-components/revision.md"),
    ("assets/task-card-components/control-plane.md", "ai/task-card-components/control-plane.md"),
    ("assets/task-card-components/spec.md", "ai/task-card-components/spec.md"),
    ("assets/task-card-components/root-cause.md", "ai/task-card-components/root-cause.md"),
    ("assets/task-card-components/tdd.md", "ai/task-card-components/tdd.md"),
    ("assets/task-card-components/large-repo.md", "ai/task-card-components/large-repo.md"),
    ("assets/task-card-components/parallel.md", "ai/task-card-components/parallel.md"),
    ("assets/task-card-components/advisor.md", "ai/task-card-components/advisor.md"),
    ("assets/task-card-components/spark.md", "ai/task-card-components/spark.md"),
    ...
    ("scripts/validate-claude-report.py", "ai/validate-claude-report.py"),
    ("scripts/compose_task_card.py", "ai/compose_task_card.py"),
    ("scripts/compile-skill-context.py", "ai/compile-skill-context.py"),
    ("scripts/build-context-checkpoint.py", "ai/build-context-checkpoint.py"),
    ("scripts/build-recovery-delta.py", "ai/build-recovery-delta.py"),
    ...
    ("scripts/monitor-claude.sh", "ai/monitor-claude.sh"),
    ...
    ("scripts/claude-process-state.py", "ai/claude-process-state.py"),
    ("scripts/process-identity.py", "ai/process-identity.py"),
    ("scripts/dispatch-preflight.py", "ai/dispatch-preflight.py"),
    ("scripts/archive-control-files.py", "ai/archive-control-files.py"),
    ("scripts/build-takeover-receipt.py", "ai/build-takeover-receipt.py"),
    ("scripts/create-dirty-snapshot.py", "ai/create-dirty-snapshot.py"),
    ("scripts/enforce-checker-contract.py", "ai/enforce-checker-contract.py"),
    ("scripts/validate-revision-card.py", "ai/validate-revision-card.py"),
    ("scripts/compare-transfer-pilot.py", "ai/compare-transfer-pilot.py"),
    ("scripts/classify-claude-attempt.py", "ai/classify-claude-attempt.py"),
    ("scripts/validate-claude-context.py", "ai/validate-claude-context.py"),
    ("scripts/parallel-task-gate.py", "ai/parallel-task-gate.py"),
