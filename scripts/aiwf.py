...
COMMANDS={"setup":"install_workflow.py","doctor":"doctor_workflow.py","task-lint":"lint-task-card.py","route":"route-task.py","accept":"evaluate-acceptance.py","review-tier":"select-review-tier.py","quota":"quota-ledger.py","cache":"context-cache.py","retry-check":"check-retry-evidence.py","review":"review-with-codex.sh","loop":"run-loop.sh","resume":"resume-run.py","handoff":"generate-handoff.py","validation-ingest":"validation-ingest.py","benchmark":"run-benchmark-suite.py","learn":"learn-store.py"}
def main():
