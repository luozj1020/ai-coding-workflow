...
def collect_facts(
    ...
    facts: Dict[str, Any] = {
        ...
        "interface_signatures": hints.get("interface_signatures", []) if isinstance(hints.get("interface_signatures", []), list) else [],
        "runnable_examples": hints.get("runnable_examples", []) if isinstance(hints.get("runnable_examples", []), list) else [],
        "async_contract": str(hints.get("async_contract") or ""),
